...
//               <div className="preview-avatar">CC</div>
...
//               <div className="balance-amount">$22,750,000.00</div>
...
//               <div className="action-chip">Buy</div>
//               <div className="action-chip">Sell</div>
//               <div className="action-chip">Swap</div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//               <div className="feature-icon" style={{ background: "#16a34a18" }}>📊</div>
//               <h3>Live Market Data</h3>
//               <p>Real-time prices, charts, and depth data for 500+ cryptocurrencies</p>
//             </div>
//             <div className="feature-card">
//               <div className="feature-icon" style={{ background: "#16a34a18" }}>🔒</div>
//               <h3>Cold Storage Security</h3>
//               <p>98% of assets stored in offline cold wallets with multi-signature protection</p>
//             </div>
//             <div className="feature-card">
//               <div className="feature-icon" style={{ background: "#16a34a18" }}>⚡</div>
//               <h3>Instant Swaps</h3>
//               <p>Swap between any cryptocurrencies instantly with competitive rates</p>
//             </div>
//             <div className="feature-card">
//               <div className="feature-icon" style={{ background: "#16a34a18" }}>💰</div>
//               <h3>Staking Rewards</h3>
//               <p>Earn up to 12% APY on your idle crypto assets through staking</p>
//             </div>
//             <div className="feature-card">
//               <div className="feature-icon" style={{ background: "#16a34a18" }}>🌐</div>
//               <h3>Multi-Chain Support</h3>
//               <p>Trade across Ethereum, Solana, BSC, Polygon, and more</p>
//             </div>
//             <div className="feature-card">
//               <div className="feature-icon" style={{ background: "#16a34a18" }}>📱</div>
...
//                 <div className="security-item">
//                   <span className="check-mark">✓</span>
//                   <span>$500M crime insurance policy</span>
//                 </div>
//               </div>
//             </div>
...
//             <div className="crypto-token">
//               <div className="token-icon">⨀</div>
//               <div className="token-name">Cardano</div>
//               <div className="token-symbol">ADA</div>
//             </div>
//             <div className="crypto-token">
//               <div className="token-icon">🔷</div>
//               <div className="token-name">Polygon</div>
//               <div className="token-symbol">MATIC</div>
//             </div>
//             <div className="crypto-token">
//               <div className="token-icon">🐶</div>
//               <div className="token-name">Dogecoin</div>
//               <div className="token-symbol">DOGE</div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//                 required
//                 className='border outline-1 border-white outline-gray-200'
//               />
//               <button type="submit" className="cta-button">Create Free Account →</button>
//             </form>
    ...
    <div className="landing-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-stats animate-fade-in-up animation-delay-4">
            <div className="stat">
              <span className="stat-number counter" data-target="2500000000">$2.5B+</span>
              <span className="stat-label">Trading volume</span>
            </div>
            <div className="stat-divider"></div>
            <div className="stat">
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card animate-on-scroll stagger-1">
              <div className="feature-icon" style={{ background: "#16a34a18" }}>
        ...
        <div className="container">
          <div className="security-content">
            <div className="security-text animate-on-scroll">
              ...
              <p>We use institutional-grade security measures to keep your digital assets safe from threats.</p>
              <div className="security-list">
                <div className="security-item hover-slide">
                  <span className="check-mark">✓</span>
                  <span>Multi-signature wallets</span>
                </div>
                <div className="security-item hover-slide">
      ...
      <section className="crypto-section">
        <div className="container">
          ...
          <div className="crypto-grid">
            <div className="crypto-token animate-on-scroll stagger-1">
              <div className="token-icon bounce">₿</div>
              <div className="token-name">Bitcoin</div>
              <div className="token-symbol">BTC</div>
            </div>
            <div className="crypto-token animate-on-scroll stagger-2">
              <div className="token-icon bounce">Ξ</div>
              <div className="token-name">Ethereum</div>
              <div className="token-symbol">ETH</div>
            </div>
            <div className="crypto-token animate-on-scroll stagger-3">
              <div className="token-icon bounce">◈</div>
              <div className="token-name">Solana</div>
              <div className="token-symbol">SOL</div>
            </div>
            <div className="crypto-token animate-on-scroll stagger-4">
              <div className="token-icon bounce">⨀</div>
              <div className="token-name">Cardano</div>
              <div className="token-symbol">ADA</div>
            </div>
            <div className="crypto-token animate-on-scroll stagger-5">
              <div className="token-icon bounce">🔷</div>
              <div className="token-name">Polygon</div>
              <div className="token-symbol">MATIC</div>
            </div>
            <div className="crypto-token animate-on-scroll stagger-6">
              <div className="token-icon bounce">🐶</div>
              <div className="token-name">Dogecoin</div>
              <div className="token-symbol">DOGE</div>
            </div>
      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer-bottom">
            <span>© 2024 CryptoCoin. All rights reserved.</span>
            <div className="social-links">
